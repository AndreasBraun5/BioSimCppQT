...
public: TextFileReader() {
        ...
        /*
        Input:			filname is the filepath, creatureList is used to store the created creatures
        ...
        */
public: void readCreatureFile(std::string filename, std::list<CreatureData>& creatureList);


        /*
        Input:			rowDescription = one row from the file, creatureInfo is used to temporary
...
public: static std::vector<std::string> errorInfo;
